      ...
      <div className="container max-w-5xl mx-auto z-10 relative px-6 md:px-12">
        ...
        >
          ...
          <motion.div 
            ...
            className="absolute w-[120%] aspect-square md:w-[80%] rounded-full border border-dashed border-white/5 z-0"
          />
          <motion.div 
            animate={{ rotate: -360 }} 
            transition={{ duration: 60, repeat: Infinity, ease: "linear" }}
            className="absolute w-[90%] aspect-square md:w-[60%] rounded-full border border-white/5 z-0 flex items-center justify-center"
          >
            {/* Orbital Particles */}
          ...
          <motion.div
            ...
            className="relative z-30 w-40 h-40 md:w-48 md:h-48 rounded-full bg-surface/80 backdrop-blur-xl border border-white/20 flex flex-col items-center justify-center shadow-[0_0_80px_rgba(45,190,96,0.2)]"
          >
            ...
            <span className="font-display font-bold text-3xl tracking-widest text-white z-10">SOLVIRE</span>

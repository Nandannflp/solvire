      ...
      <div className="container max-w-4xl mx-auto px-6 md:px-12 relative z-10">
        ...
        >
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            {/* Right side: Results */}
            <div className="flex flex-col justify-center items-center p-8 rounded-2xl bg-white/5 border border-white/10 text-center relative overflow-hidden">
              {/* Subtle ambient light */}
              <div className="absolute top-0 right-0 w-32 h-32 bg-energy/10 blur-[50px]" />
              ...
              {systemSize > 0 ? (
                ...
                >
                  <div className="bg-black/40 p-4 rounded-xl border border-white/5">
                    ...
                    <div className="text-4xl font-bold text-white">{systemSize} <span className="text-xl text-white/50">kW</span></div>
                  </div>

                  <div className="bg-black/40 p-4 rounded-xl border border-white/5">
                    <div className="flex items-center justify-center gap-2 text-solar mb-1">
                  ...
                  <button 
                    ...
                    className="mt-4 w-full group relative inline-flex items-center justify-center gap-2 px-6 py-4 bg-primary hover:bg-primary/90 text-white rounded-xl font-medium overflow-hidden transition-all shadow-lg shadow-primary/20"
                  >
                ...
                <div className="flex flex-col items-center opacity-50 py-12">
                  <Calculator className="w-16 h-16 text-white/20 mb-6" />

...
export function MonitoringSection() {
  return (
    <section className="relative py-24 md:py-32 bg-black border-t border-white/10 overflow-hidden">
      {/* Background glow */}
      <div className="absolute top-1/2 right-0 w-[500px] h-[500px] bg-energy/10 blur-[100px] rounded-full pointer-events-none translate-x-1/2 -translate-y-1/2" />
      ...
      <div className="container max-w-7xl mx-auto px-6 md:px-12 relative z-10">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
              ...
              <div className="absolute inset-x-0 bottom-0 p-6 flex flex-col gap-4 z-10">
                <div className="bg-white/10 backdrop-blur-md rounded-2xl p-4 border border-white/10">
                  ...
                  <div className="text-3xl font-bold text-white flex items-end gap-2">
                    5.4 <span className="text-lg text-energy mb-1">kW</span>
                  </div>
                </div>
                <div className="bg-white/10 backdrop-blur-md rounded-2xl p-4 border border-white/10 flex justify-between items-center">
                  ...
                  <BarChart3 className="w-8 h-8 text-energy" />
                </div>
              </div>
            </div>
            
            {/* Decorative elements */}
            <div className="absolute top-1/4 -left-8 w-16 h-16 bg-surface border border-white/10 rounded-2xl shadow-xl flex items-center justify-center animate-[bounce_3s_infinite]">
              <Activity className="w-8 h-8 text-energy" />
            </div>
            <div className="absolute bottom-1/4 -right-8 w-16 h-16 bg-surface border border-white/10 rounded-2xl shadow-xl flex items-center justify-center animate-[bounce_4s_infinite]">
              <BellRing className="w-8 h-8 text-solar" />
            </div>
          </motion.div>
          ...
          >
            <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-white/5 text-white/80 text-sm font-medium mb-6 border border-white/10">
            ...
            <div className="space-y-6">
              {[
                ...
                <div key={idx} className="flex gap-4">
                  <div className="w-8 h-8 rounded-full bg-energy/20 flex items-center justify-center shrink-0 mt-1">

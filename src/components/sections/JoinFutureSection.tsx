    ...
    >
      ...
      <div className="container max-w-4xl mx-auto z-10 relative px-6 md:px-12 text-center flex flex-col items-center">
        ...
        >
          ...
          <div className="w-16 h-16 mx-auto bg-white/60 backdrop-blur-sm rounded-2xl flex items-center justify-center border border-border shadow-sm relative mb-8">

          ...
          <div>
            ...
            <div className="space-y-8">
              <div className="flex gap-4 items-start">
                <div className="w-10 h-10 rounded-full bg-energy/10 flex items-center justify-center shrink-0">
              ...
              <div className="flex gap-4 items-start">
                <div className="w-10 h-10 rounded-full bg-solar/10 flex items-center justify-center shrink-0">
                  <ShieldAlert className="w-5 h-5 text-solar" />
                </div>
                <div>
            ...
            <div className="mt-12 p-6 bg-surface/50 border border-border rounded-xl">
              <p className="text-sm text-textSecondary">
                For urgent grid-down emergencies, please call our 24/7 hotline directly:
                <br/>
                <a href="tel:18002120000" className="text-energy font-semibold text-lg mt-2 inline-block">1800-212-SOLAR</a>
              </p>
            </div>
          </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div className="space-y-2">
                ...
                <select 
                  id="issueType" 
                  required
                  className="w-full bg-background/50 border border-foreground/10 rounded-lg px-4 py-3 text-foreground placeholder-textSecondary/50 focus:outline-none focus:border-energy/50 transition-colors appearance-none [&>option]:bg-[#111]" 
                >

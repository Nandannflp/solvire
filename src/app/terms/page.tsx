  ...
  return (
    <div className="relative min-h-screen bg-background py-32 px-6 md:px-12 overflow-hidden">
      ...
      <div className="container max-w-3xl mx-auto relative z-10">
        ...
        <h1 className="text-4xl md:text-5xl font-semibold text-foreground mb-12">Terms of Service</h1>
        ...
        <div className="space-y-8 text-textSecondary leading-relaxed">
          ...
          <section>
            <h2 className="text-xl font-medium text-foreground mb-4">2. Use License</h2>
            <p>
          ...
          <section>
            <h2 className="text-xl font-medium text-foreground mb-4">3. Service Provision</h2>
            <p>
          ...
          <section>
            <h2 className="text-xl font-medium text-foreground mb-4">4. System Performance</h2>
            <p>
          ...
          <section>
            <h2 className="text-xl font-medium text-foreground mb-4">5. Governing Law</h2>
            <p>
